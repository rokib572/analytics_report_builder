...
Required: `DATABASE_URL`, `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL`, `SQUARE_OAUTH_CLIENT_ID`, `SQUARE_OAUTH_CLIENT_SECRET`, `SQUARE_APP_ACCESS_TOKEN`, `SQUARE_WEBHOOK_SECRET`.
